...
if __name__=='__main__': 
    ...
    config["lr"] = 0.01
    config["model_name"] = "tentwo3whnum467d4cat2467Yblock_decoderRDDwhpaper1024uafmspchcat"
    config["log_path"] = "./log_file/WH_DW_tentwo3whnum467d4cat2467Yblock_decoderRDDwhpaper1024uafmspchcat"
    config["save_best_path"] = './pth_file/best_WH_DW_tentwo3whnum467d4cat2467Yblock_decoderRDDwhpaper1024uafmspchcat.pth'
    #config["train_split"]="trainval"
    config["train_crop_size"] = [512,1024]
    #config["pretrained_path"] = './pth_file/best_WH_DW_tentwo3wh17_decoderRDDwh6_second.pth'
    config["epochs"] = 2000
