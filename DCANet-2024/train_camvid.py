...
if __name__=='__main__': 
    ...
    config["dataset_dir"]="./camvid_dataset" # If you put the dataset at another place, change this
    config["lr"]=0.01
    config["class_uniform_pct"]=0 # since we're only evalutaing, not training
    #config["model_name"] = "tentwo3wh17_decoderRDDwh27"
    #config["log_path"] = "./log_file/WH_DW_camvid_tentwo3wh17_decoderRDDwh27"
    #config["save_best_path"] = './pth_file/best_WH_DW_camvid_tentwo3wh17_decoderRDDwh27.pth'
    config["model_name"] = "tentwo3whnum01234selfvits5b2rightddlight1_decoderRDDwhpaper640s5camvid"
    config["log_path"] = "./log_file/WH_DW_camvid_tentwo3whnum01234selfvits5b2rightddlight1_decoderRDDwhpaper640s5camvid"
    config["save_best_path"] = './pth_file/best_WH_DW_camvid_tentwo3whnum01234selfvits5b2rightddlight1_decoderRDDwhpaper640s5camvid.pth'
    #config["train_split"]="trainval"
    #config["model_name"] = "exp53_decoder29"
    #config["log_path"] = "./log_file/WH_DW_camvid_exp53_decoder29"
    #config["save_best_path"] = './pth_file/best_WH_DW_camvid_exp53_decoder29.pth'
    config["train_crop_size"] = [720,960]
    #config["pretrained_path"] = './pth_file/best_WH_DW_tentwo3whnum01234selfvits5b2rightddlight1_decoderRDDwhpaper640s6.pth'
    config["epochs"] = 2000
