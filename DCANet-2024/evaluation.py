...
if __name__ =="__main__":
    torch.cuda.set_device(1)  #指定使用的卡  单卡
    ...
    # config["model_name"] = "tentwo1selfattention_decoderRDD8selfattention"
    # config["save_best_path"] = './pth_file/best_WH_DW_tentwo1selfattention_decoderRDD8selfattention.pth'
