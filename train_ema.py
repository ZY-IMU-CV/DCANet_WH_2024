...
def train_one_epoch(ema,model, loss_fun, optimizer, loader, lr_scheduler, print_every, mixed_precision, scaler):
    model.train()
    #model.cpu()
    losses=0
...
def train_one(config):
    ...
    for epoch in range(epoch_start,epochs):
        ...
        average_loss=train_one_epoch(ema,model, loss_fun, optimizer, train_loader, lr_scheduler, print_every=train_print_every, mixed_precision=mixed_precision, scaler=scaler)
        with open(log_path,"a") as f:
...
if __name__=='__main__':
    ...
    config["log_path"] = "./log_file/DW_tentwo1_8"
    config["save_best_path"] = './pth_file/best_DW_tentwo1_8.pth'
