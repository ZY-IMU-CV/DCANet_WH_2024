...
class DDWblock_mobileone_k3( nn.Module):  # wh
    def __init__(self, in_channels, out_channels, dilations, group_width, stride,
                 attention="se"):  # inchanel=128, outchannel=128
        super().__init__()
        avg_downsample = True
        ...
        self.conv1_1 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=dilation,groups=in_channels,dilation=dilation,bias=False)
        self.conv1_2 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=dilation,groups=in_channels,dilation=dilation, bias=False)
        self.conv1_3 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=dilation,groups=in_channels,dilation=dilation, bias=False)
        self.conv1_4 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=dilation,groups=in_channels, dilation=dilation, bias=False)

        self.bn2 = norm2d(out_channels)
        # self.bn1_2 = norm2d(out_channels)
        # self.bn1_3 = norm2d(out_channels)
        # self.bn1_4 = norm2d(out_channels)

        self.conv3 = nn.Conv2d(in_channels, out_channels, kernel_size=1, bias=False)

        self.bn4 = norm2d(out_channels)

        self.act5 = activation()

        self.conv6_1 = nn.Conv2d(out_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv6_2 = nn.Conv2d(out_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv6_3 = nn.Conv2d(out_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv6_4 = nn.Conv2d(out_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=False)

        self.bn7 = norm2d(out_channels)

        self.act8 = activation()
    ...
    def forward(self, x):
        ...
        x_final1 = x1_1+x1_2
        x_final1 = x_final1+x1_3
        x_final1 = x_final1+x1_4
        x_final1 = x_final1+x2
        x_final1 = self.act5(x_final1)

        x4_1 = self.conv6_1(x_final1)
        x4_2 = self.conv6_2(x_final1)
        x4_3 = self.conv6_3(x_final1)
        x4_4 = self.conv6_4(x_final1)
        ...
        x5 = self.bn7(x_final1)

        x_final2 = x4_1+x4_2+x4_3+x4_4+x5
        x_final2 = self.act8(x_final2)

        return x_final2

class DDWblock_mobileone_k3_2( nn.Module):  # wh
    def __init__(self, in_channels, out_channels, dilations, group_width, stride,
                 attention="se"):  # inchanel=128, outchannel=128
        super().__init__()
        avg_downsample = True
...
class RegSegBody_17_wh23(nn.Module):  # 将block换为mobileone的block
    def __init__(self):
        super().__init__()
        gw = 16
        dilations1 = 4
        ...
        attention = 'se'
        self.stage4 = nn.Sequential(
            DDWblock_mobileone_k3(32,64,dilations2,1,2,attention),
            DDWblock_mobileone_k3(64,64,dilations2,1,1,attention)
            #ConvBnAct(32, 64, 3, 2, 1)

        )
        self.stage8 = nn.Sequential(
            DDWblock_mobileone_k3(64, 128, dilations2, 1, 2, attention),
            DDWblock_mobileone_k3(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(128, 128, dilations2, 1, 1, attention),
        ...
        self.stage16 = nn.Sequential(
            DDWblock_mobileone_k3(128, 256, dilations2, 1, 2, attention),
            DDWblock_mobileone_k3(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3(256, 256, dilations2, 1, 1, attention),
        ...
        self.stage32 = nn.Sequential(
            DDWblock_mobileone_k3(256, 1024, dilations2, 1, 2, attention),
        )
    ...
    def channels(self):
        return {"4": 64, "8": 128, "16": 256, "32": 1024}

class RegSegBody_17_wh26(nn.Module):  # 将block换为mobileone的block
    def __init__(self):
        super().__init__()
        gw = 16
        dilations1 = 4
        ...
        attention = 'se'
        self.stage4 = nn.Sequential(
            DDWblock_mobileone_k3_2(32,64,dilations2,1,2,attention),
            DDWblock_mobileone_k3_2(64,64,dilations2,1,1,attention)
            #ConvBnAct(32, 64, 3, 2, 1)

        )
        self.stage8 = nn.Sequential(
            DDWblock_mobileone_k3_2(64, 128, dilations2, 1, 2, attention),
            DDWblock_mobileone_k3_2(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(128, 128, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(128, 128, dilations2, 1, 1, attention),
        ...
        self.stage16 = nn.Sequential(
            DDWblock_mobileone_k3_2(128, 256, dilations2, 1, 2, attention),
            DDWblock_mobileone_k3_2(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(256, 256, dilations2, 1, 1, attention),
            DDWblock_mobileone_k3_2(256, 256, dilations2, 1, 1, attention),
