...
if __name__ =="__main__":
    torch.cuda.set_device(2)  #指定使用的卡  单卡
    print("the evaluation's device number is ***********:",torch.cuda.current_device())
    ...
    config["model_name"] = "tentwo3whnum467d4cat2467_decoderRDDwhpapercamvid1024uafmspchcat"
    config["save_best_path"] = './pth_file/best_WH_DW_camvid_tentwo3whnum467d4cat2467_decoderRDDwhpapercamvid1024uafmspchcatpretrain.pth'
    ...
    #val_data = val_data.get_camvid('./camvid_dataset/',(360,480),(360,480),0.5,'val',4)
