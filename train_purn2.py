...
def train_one_epoch(epoch,model, loss_fun, optimizer, loader, lr_scheduler, print_every, mixed_precision, scaler):
    model.train()
    #model.cpu()
    losses=0
    ...
    for t, x in enumerate(loader):
        ...
        (model.body.stage4.conv1, 'weight'),
        (model.body.stage4.conv2, 'weight'),
        (model.body.stage4.conv3, 'weight'),
        (model.body.stage8[0].conv1, 'weight'),
        (model.body.stage8[0].conv2, 'weight'),
        (model.body.stage8[0].conv3, 'weight'),
        (model.body.stage8[1].conv1, 'weight'),
        (model.body.stage8[1].conv2, 'weight'),
        (model.body.stage8[1].conv3, 'weight'),
        (model.body.stage16[0].conv1, 'weight'),
        (model.body.stage16[0].conv2, 'weight'),
        (model.body.stage16[0].conv3, 'weight'),
        (model.body.stage16[1].conv1, 'weight'),
        (model.body.stage16[1].conv2, 'weight'),
        (model.body.stage16[1].conv3, 'weight'),
        (model.body.stage16[2].conv1, 'weight'),
        (model.body.stage16[2].conv2, 'weight'),
        (model.body.stage16[2].conv3, 'weight'),
        (model.body.stage32[0].conv1, 'weight'),
        (model.body.stage32[0].conv2, 'weight'),
        (model.body.stage32[0].conv3, 'weight'),
        (model.body.stage32[1].conv1, 'weight'),
        (model.body.stage32[1].conv2, 'weight'),
        (model.body.stage32[1].conv3, 'weight'),
        (model.body.stage32[2].conv1, 'weight'),
        (model.body.stage32[2].conv2, 'weight'),
        (model.body.stage32[2].conv3, 'weight'),
        (model.body.stage32[3].conv1, 'weight'),
        (model.body.stage32[3].conv2, 'weight'),
        (model.body.stage32[3].conv3, 'weight'),
        (model.decoder.conv16.conv, 'weight'),
        (model.decoder.conv8.conv, 'weight'),
        (model.decoder.conv4.conv, 'weight'),
        (model.decoder.head16.conv, 'weight'),
        (model.decoder.head8.conv, 'weight'),
        (model.decoder.head4.conv, 'weight'),
        (model.decoder.head32.conv, 'weight')
    )
        if epoch >350 and t%print_every==0:
...
def train_one(config):
    ...
    for epoch in range(epoch_start,epochs):
        ...
        average_loss=train_one_epoch(epoch,model, loss_fun, optimizer, train_loader, lr_scheduler, print_every=train_print_every, mixed_precision=mixed_precision, scaler=scaler)
        with open(log_path,"a") as f:
...
if __name__=='__main__':
    ...
    config["model_name"] = "tentwo1_decoderdown32"
    config["log_path"] = "./log_file/DW_tentwo1_prune2"
    config["save_best_path"] = './pth_file/best_DW_tentwo1_prune2.pth'
